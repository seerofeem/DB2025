...
VALUES
  ...
  ('Fatima', 'Orynova', (SELECT dept_id FROM departments WHERE dept_name = 'Sales'), 45000, '2021-03-20', 'Active'),
  ('Gulnara', 'Bektas', (SELECT dept_id FROM departments WHERE dept_name = 'Junior'), 35000, '2024-02-01', 'Active'),
  ('Hassan', 'Zhumadil', (SELECT dept_id FROM departments WHERE dept_name = 'Senior'), 85000, '2016-11-10', 'Active'),
  ('Ilyas', 'Bek', NULL, NULL, '2024-05-10', 'Inactive')
